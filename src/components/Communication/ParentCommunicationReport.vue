...
export default {
  data() {
    return {
      ...
      school_id: "",
      coming_from: "",
      heading: "Download Monthly Parent Communication Report",
  ...
  methods: {
    download() {
      ...
      if (can_search) {
        ...
        let url = self.ip.concat("/operations/parents_communication_report/");
        console.log("url=", url);
        ...
        axios
          ...
          .then(function(response) {
            ...
            link.href = url;
            var file_name =
              "Parent_Communication_Report_" + self.date + ".xlsx";
